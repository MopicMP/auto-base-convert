...
> Auto convert between base2/8/10/16/36/62

[![PyPI version](https://badge.fury.io/py/auto-base-convert.svg)](https://pypi.org/project/auto-base-convert/)
...
```bash
pip install auto-base-convert
```

## Quick Start

```python
from auto_base_convert import convert
...
from auto_base_convert import batch
